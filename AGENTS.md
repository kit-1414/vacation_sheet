...
Страница содержит список пользователей системы с атрибутами, кнопку перехода на страницу «Добавление пользователя» и ссылки на страницы редактирования пользователей.
