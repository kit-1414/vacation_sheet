...
#### Страница "Список проектов"
  ...
  - имя
  - время добавления
  - размер команды в виде числа, являющегося ссылкой на страницу редактирования участников проекта;
...
Страница позволяет добавлять и удалять участников проекта. В списке пользователей необходимо показывать email, имя и фамилию. Список можно сортировать по одной любой колонке и фильтровать по любой колонке с использованием условия `LIKE '%<pattern>%'`.
